...
https://github.com/haofanwang/video-swin-transformer-pytorch/blob/main/video_swin_transformer.py
'''
...
class PatchEmbed3D(nn.Module):
    ...
    def __init__(self, patch_size=(2, 4, 4), in_chans=2, embed_dim=96, norm_layer=None):
        super().__init__()
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        self.head = classHead(self.num_features)
