...
from model.arch.timesformer_utils import DropPath, to_2tuple, trunc_normal_, load_pretrained
from model.arch.timesformer_utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
...
class TimeSformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, num_classes=1, num_frames=8, attention_type='divided_space_time',
