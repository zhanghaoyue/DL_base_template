# From https://github.com/alpErenSari/spatioTemporalTransformer/blob/master/models.py
...
class DVDModel(nn.Module):
    def __init__(self):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.conv1 = nn.Conv2d(in_channels=2, out_channels=64, kernel_size=5, stride=1, padding=2, bias=False)
